...
// }
// console.log(idx);
//***Finding if an element exists in the array ot not and updating the array

// function updateNameArr (names, name){
//   if(names.indexOf(name) === -1) {
//     names.push(name);
//     console.log('New name addes to the list and it is : ' + name);
//   }else {
//     console.log(name  +  ' already exists in the name list.');
//   }
// }

// updateNameArr (names, "aliya")
// updateNameArr (names, "aliya")
